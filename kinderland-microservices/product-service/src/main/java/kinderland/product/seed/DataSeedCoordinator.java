package kinderland.product.seed;
...
public class DataSeedCoordinator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        log.info("Starting Kinderland Product-Service seed process. Seeder count: {}", seeders.size());
        ...
        log.info("Kinderland Product-Service seed process completed.");
    }
}
