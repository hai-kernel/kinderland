...
public class DataSeedCoordinator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        log.info("Starting Kinderland Order-Service seed process. Seeder count: {}", seeders.size());
        ...
        log.info("Kinderland Order-Service seed process completed.");
    }
}
