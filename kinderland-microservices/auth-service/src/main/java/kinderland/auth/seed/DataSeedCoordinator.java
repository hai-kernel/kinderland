...
public class DataSeedCoordinator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        log.info("Starting Kinderland Auth-Service seed process. Seeder count: {}", seeders.size());
        ...
        log.info("Kinderland Auth-Service seed process completed.");
    }
}
