...
export default function NewArrivalsPage() {
  ...
  const currentProducts = newProducts.slice(startIndex, startIndex + itemsPerPage);
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#78A2D2] via-[#6A94C4] to-[#78A2D2] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-3 bg-white/20 px-6 py-3 rounded-full mb-4 backdrop-blur-sm">
            ...
            <span className="font-bold text-lg">HÀNG MỚI VỀ</span>
          </div>
          <h1 className="text-5xl font-bold mb-4">
            Sản Phẩm Mới Nhất
          </h1>
          <p className="text-xl text-white/90">
            Cập nhật liên tục các món đồ chơi hot nhất thị trường
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-2">
          <Sparkles className="size-8 text-[#78A2D2]" />
          <h1 className="text-4xl font-bold text-[#78A2D2]">Hàng Mới Về</h1>
        </div>
        ...
        {currentProducts.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-gray-500 text-lg">Chưa có sản phẩm mới</p>
          </div>
        ) : (
          <>
